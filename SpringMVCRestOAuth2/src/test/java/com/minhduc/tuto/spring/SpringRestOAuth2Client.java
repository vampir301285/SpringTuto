...
import com.minhduc.tuto.spring.model.AuthTokenInfo;
import com.minhduc.tuto.spring.model.User;

public class SpringRestOAuth2Client {
    public static final String REST_SERVICE_URI = "http://localhost:8080/SpringMVCRestOAuth2";

    public static final String AUTH_SERVER_URI = "http://localhost:8080/SpringMVCRestOAuth2/oauth/token";
